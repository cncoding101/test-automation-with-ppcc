...
function getLogLevel(logLevel: LogLevel): LogLevel[] {
...
const stringIsOfOptions = <T extends string>(logLevel: string, options: readonly string[]): T => {
...
export { stringIsOfOptions, getLogger };
